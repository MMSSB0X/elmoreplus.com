...
// // Replace these with your real image links!
// // ==========================================
...
//         const finalPicUrl = cleanImageUrl(document.getElementById("edit-pic").value.trim()); 

//         try {
//             await updateDoc(doc(db, "users", currentUserUid), {
//                 profilePic: finalPicUrl || `https://placehold.co/150x150/87CEEB/FFF?text=U`,
...
// // ADVANCED GOOGLE DRIVE LINK CLEANER
// function cleanImageUrl(url) {
//     if (!url) return "";
//     if (url.includes("drive.google.com")) {
//         // Extracts the unique ID from any Google Drive link
//         const match = url.match(/\/d\/([a-zA-Z0-9_-]+)/);
//         if (match && match[1]) {
//             // Uses Google's dedicated image content server to bypass CORS blocks
